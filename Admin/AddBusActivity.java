...
//                Log.d(TAG, "OnDateSet:date :" + day + "/" + (month + 1) + "/" + year);
        ...
        String[] items1 = new String[]{"From", "Koyembedu", "Guindy", "Adayar", "Kotturpuram", "T nagar", "Besant nagar", "Nerkundram"};
        ArrayAdapter<String> adapter1 = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, items1);
        spinner1.setAdapter(adapter1);

        //To
        Spinner spinner2 = findViewById(R.id.busTo);
        String[] items2 = new String[]{"To", "Koyembedu", "Guindy", "Adayar", "Kotturpuram", "T nagar", "Besant nagar", "Nerkundram"};
    ...
    private void addBuses() {
        ...
        Bus bus = new Bus(busId, travelsNameI, busNumberI, date, from, to);
